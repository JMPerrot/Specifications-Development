...
for (parm in Parms2Estimate){
  ...
  FileName <- file.path(SpecSampling_Dir,paste(parm,'_SpecSampling.csv',sep = ''))
...
for (parm in Parms2Estimate){
  ...
  filename = file.path(SpecSampling_Dir,paste('NRMSE_',parm,'_SpecSampling_R_N.png',sep = ''))
...
## save figures ----------------------------------------------------------------
ggsave(file.path(SpecSampling_Dir,
                 paste('NRMSE_ALL','_SpecSampling_T_N.png',sep = '')), 
       plot_nrmse,
       device = "png")
